...
tap "jackielii/tap"
tap "nikitabobko/tap"
tap "ochcaroline/tap", trusted: true
tap "powershell/tap"
tap "tufin/tufin"
...
brew "jackielii/tap/skhd-zig", trusted: true
# K1s, kubernetes made simple
brew "ochcaroline/tap/k1s"
# Secretly - secret management in the terminal
brew "ochcaroline/tap/secretly"
# Slides in the terminal. And nothing else
...
uv "specify-cli", source: "git+https://github.com/github/spec-kit.git@v0.11.8"
npm "@github/local-action"
npm "@types/node"
npm "@vue/cli"
